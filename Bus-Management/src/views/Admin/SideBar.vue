...
<div class="min-h-screen flex flex-row bg-white">
  ...
  <div class=" flex-grow bg-white">
    ...
    <thead class="bg-white divide-y divide-gray-200">
        ...
        <tr>
            <th class="px-200 py-3 text-centre text-xs font-medium text-gray-500 uppercase tracking-wider">User Name</th>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap">17/2</td>
             <td class="px-6 py-4 whitespace-nowrap">012345657</td>
