<template>
  ...
  <div class="min-h-screen flex flex-row bg-white">
    <div class="flex flex-col w-56 bg-white rounded-r-3xl ">
      <div class="flex items-center justify-center h-20">
          <div class="flex items-center justify-center h-20 ">
    <img src="/assets/img/buslogo.png" alt="Logo" class="h-full">
  </div>
      ...
      <ul class="flex flex-col py-4">
        ...
        <li>
          <a href="#" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
            ...
            <span class="text-sm font-medium">Đơn vị quản lý xe</span>
          </a>
        </li>
        ...
        <li>
          <a href="#" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
            ...
            <span class="text-sm font-medium">Tài xế</span>
          </a>
        </li>
    ...
    <div class=" flex-grow bg-white">
      ...
      <thead class="bg-white divide-y divide-gray-200">
          <tr class="bg-white divide-y divide-gray-200">
            <button
                  class="bg-[#1a5b34e0] hover:bg-[#1a5b34e0] text-white py-1 px-3 sm float-right inline-block mr-5 " style="margin-top: 20px; margin-right: 40px;"
                >
                  Add  +
                </button>
          </tr>
          <tr>
              <th class="px-200 py-3 text-centre text-xs font-medium text-gray-500 uppercase tracking-wider">Mã đơn vị</th>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Lộ trình đi</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Lộ trình về</th>
      ...
      <tbody class="bg-white divide-y divide-gray-200">
          <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap">Da Lat</td>
              <td class="px-6 py-4 whitespace-nowrap">2:00 pm</td>
              <td class="px-6 py-4 whitespace-nowrap">4:00 pm</td>
              <td class="px-6 py-4 whitespace-nowrap">4:20 pm</td>
               <td class="px-6 py-4 whitespace-nowrap">P8</td>
               <td class="px-6 py-4 whitespace-nowrap">P2</td>
               <td class="px-6 py-4 whitespace-nowrap">Bus</td>
